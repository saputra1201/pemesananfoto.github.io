...
if(isset($_POST['keyword']))
{
	...
	$sql = "select * from tabel_anggota_baru where nama like '%$keyword%'";
}
else{
	$sql = "select * from tabel_anggota_baru order by id_anggota";
}
...
echo "<tr>
		...
		<td>
			<a href='konfirmasi.php?id_anggota=$id_anggota'>konfirmasi</a>
		</td>
	</tr>";
	$i++;
}
